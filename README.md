...
- configurable Classic, State GEX, and State Gamma Majors that do not require their related profiles, with optional GEX bar magnitudes, visibility, color, label placement, line style, and thickness;
